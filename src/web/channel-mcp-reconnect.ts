...
// Test-only escape hatch: the post-loop "still not idle" warn at L49 is
// unreachable through attemptChannelMcpReconnect alone because the production
// path always exhausts or short-circuits earlier in ways that don't
// deterministically drive 4×non-idle captures. Exporting the function under
// `__test_` lets the suite exercise both branches of the
