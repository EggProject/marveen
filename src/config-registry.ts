...
export const SETTINGS_REGISTRY: SettingDefinition[] = [
  ...
  // --- Install identity and runtime configuration ---
  {
    key: 'IDENTITY_CONFIRMED',
    type: 'boolean',
    default: '0',
    description: 'Az onboarding identity lépésének belső kész állapota.',
    module: 'onboarding',
    secret: false,
    requiresRestart: false,
  },
  {
    ...
    type: 'string',
    default: 'Owner',
    description: 'A telepítés tulajdonosának megjelenített neve.',
    module: 'system',
    secret: false,
    requiresRestart: false,
  },
  {
    ...
    type: 'string',
    default: '',
    description: 'A flotta alapértelmezett közös Google Drive mappája.',
    module: 'system',
    secret: false,
  ...
  },
  {
    ...
    type: 'string',
    default: 'Marveen',
    description: 'A fő agent megjelenített neve.',
    module: 'system',
    secret: false,
    requiresRestart: false,
  },
  {
    ...
    type: 'string',
    default: '',
    description: 'A termék neve a dashboard felületén. Üresen a BOT_NAME érvényesül.',
    module: 'system',
    secret: false,
    requiresRestart: false,
  },
  {
    ...
    type: 'string',
    default: 'marveen',
    description: 'A fő agent stabil belső azonosítója.',
    module: 'system',
    secret: false,
    requiresRestart: true,
  },
  {
    ...
    type: 'string',
    default: 'marveen',
    description: 'Az OS service unitok stabil azonosítója.',
    module: 'system',
    secret: false,
    requiresRestart: true,
  },
  {
    ...
    min: 1,
    max: 65535,
    description: 'A dashboard HTTP portja.',
    module: 'system',
    secret: false,
    requiresRestart: true,
  },
  {
    ...
    type: 'string',
    default: '127.0.0.1',
    description: 'A dashboard bind címe.',
    module: 'system',
    secret: false,
    requiresRestart: true,
  },
  {
    key: 'DASHBOARD_ALLOWED_ORIGINS',
    type: 'string',
    default: '',
    description: 'További engedélyezett dashboard originek, vesszővel elválasztva.',
    module: 'system',
    secret: false,
    requiresRestart: true,
  },
  {
    ...
    type: 'string',
    default: '',
    description: 'A tulajdonos engedélyezett channel chat azonosítója.',
    module: 'channels',
    secret: false,
    requiresRestart: true,
  },
  {
    ...
    type: 'string',
    default: '',
    description: 'Az alapértelmezett Slack csatorna azonosítója.',
    module: 'channels',
    secret: false,
    requiresRestart: true,
  },
  {
    ...
    type: 'string',
    default: '',
    description: 'Az alapértelmezett Discord csatorna azonosítója.',
    module: 'channels',
    secret: false,
    requiresRestart: true,
  },
  {
    key: 'GOOGLECHAT_PROJECT_ID',
    type: 'string',
    default: '',
    description: 'A Google Chat projektazonosítója.',
    module: 'channels',
    secret: false,
    requiresRestart: true,
  },
  {
    key: 'GOOGLECHAT_SPACE_ID',
    type: 'string',
    default: '',
    description: 'Az alapértelmezett Google Chat space azonosítója.',
    module: 'channels',
    secret: false,
    requiresRestart: true,
  },
  {
    ...
    type: 'string',
    default: '',
    description: 'A Teams bot alkalmazásazonosítója.',
    module: 'channels',
    secret: false,
    requiresRestart: true,
  },
  {
    key: 'TEAMS_ALLOWED_CONVERSATION_ID',
    type: 'string',
    default: '',
    description: 'Az engedélyezett Teams conversation azonosítója.',
    module: 'channels',
    secret: false,
    requiresRestart: true,
  },
  {
    ...
    type: 'string',
    default: 'telegram',
    valueSet: ['telegram', 'slack', 'discord', 'whatsapp', 'googlechat', 'teams'],
    description: 'A fő agent elsődleges channel providere.',
    module: 'channels',
    secret: false,
    requiresRestart: true,
  },
  {
    key: 'CHANNEL_PLUGINS_EXTRA',
    type: 'string',
    default: '',
    description: 'A fő session további channel plugin azonosítói, szóközzel elválasztva.',
    module: 'channels',
    secret: false,
    requiresRestart: true,
  },
  {
    ...
    default: '0',
    valueSet: ['0', '1'],
    description: 'A sub-agent channel inbox tee opt-in kapcsolója.',
    module: 'channels',
    secret: false,
    requiresRestart: true,
  },
  {
    ...
    default: '0',
    valueSet: ['0', '1'],
    description: 'A sub-agent Telegram inbox wake-nudge opt-in kapcsolója.',
    module: 'channels',
    secret: false,
    requiresRestart: true,
  },
  {
    ...
    min: 30000,
    max: 3600000,
    description: 'Az inbound channel probe futási intervalluma milliszekundumban.',
    module: 'channels',
    secret: false,
    requiresRestart: true,
  },
  {
    ...
    type: 'string',
    default: '',
    valueSet: ['', '0', '1', 'false', 'true'],
    description: 'A channel respawn explicit felülbírálása.',
    module: 'channels',
    secret: false,
    requiresRestart: true,
  },
  {
    ...
    type: 'string',
    default: '',
    description: 'Hostnév-részlet, amelyen a channel respawn engedélyezett.',
    module: 'channels',
    secret: false,
    requiresRestart: true,
  },
  {
    ...
    description: 'A kanban címkék választható színpalettája.',
    module: 'kanban',
    secret: false,
    requiresRestart: false,
  },
  ...
  // --- Channels module ---
  {
    ...
    type: 'string',
    default: '',
    description: 'A MiniMax Anthropic-kompatibilis végpont URL-je. Üresen a MiniMax modell indítása NEM engedett.',
    module: 'providers',
    secret: false,
    requiresRestart: true,
  },
  {
    ...
    description: 'A MiniMax alapértelmezett canonical modell referenciája.',
    module: 'providers',
    secret: false,
    requiresRestart: true,
  },
  {
    key: 'DEEPSEEK_API_KEY_VAULT_ID',
    type: 'string',
    default: 'DEEPSEEK_API_KEY',
    description: 'A DeepSeek Vault secret azonosítója.',
    module: 'providers',
    secret: false,
    requiresRestart: true,
  },
  {
    key: 'OPENROUTER_FLEET_KEY_VAULT_ID',
    type: 'string',
    default: 'openrouter-fleet-key',
    description: 'Az OpenRouter Vault secret azonosítója.',
    module: 'providers',
    secret: false,
    requiresRestart: true,
  },
  {
    key: 'MINIMAX_API_KEY_VAULT_ID',
    type: 'string',
    default: 'MINIMAX_API_KEY',
    description: 'A MiniMax Vault secret azonosítója.',
    module: 'providers',
    secret: false,
    requiresRestart: true,
  },
  {
    key: 'MINIMAX_MODEL_REFS',
    type: 'string',
    default: 'minimax:MiniMax-M3',
    description: 'A MiniMax provider által kínált canonical modell referenciák (soronként).',
    module: 'providers',
    secret: false,
    requiresRestart: true,
  },
  ...
  },
  {
    ...
    type: 'string',
    default: `anthropic:${DISTRIBUTION_DEFAULT_AGENT_MODEL}`,
    description: 'Az új ügynökök alapértelmezett canonical modell referenciája, egyben a háttér-worker sessionök modellje. Meglévő ügynökök NEM változnak: akinek az agent-config.json-jában konkrét modell van, az marad. A módosítás a szolgáltatás újraindításakor lép életbe.',
    module: 'agents',
    secret: false,
    requiresRestart: true,
    valueSet: [
