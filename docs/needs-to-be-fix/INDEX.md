...
| `multipart-boundary-greedy` | `src/web/multipart.ts:9-12` | greedy `boundary=(.+)` keeps quotes and trailing params, silently corrupting every field | `src/__tests__/multipart.test.ts` | Resolved: 2026-08-20 6b82c2f6f117b862fc34dede4fac6bfc2d52d569 |
| `multipart-latin1-fields` | `src/web/multipart.ts:31,36` | text fields and filenames are latin1-decoded, so every non-ASCII value is mojibake | `src/__tests__/multipart.test.ts` | Resolved: 2026-08-20 6b82c2f6f117b862fc34dede4fac6bfc2d52d569 |
