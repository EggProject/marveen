...
| `message-router-cache-fallback-unreachable` | message-router.ts: cached session-lookup `??` fallback arms are unreachable | Resolved: 2026-08-25 232fac7 (isMainAgent ternary at line 482 deleted via `const host = cached.host`; combined with 900cdb6; file-level branch coverage 99.24% -> 100%) -- see message-router-cache-fallback-unreachable.md |
| `message-router-dead-defensive-branches` | message-router.ts: three dead defensive branches block 100% branch coverage | Resolved: 2026-08-25 232fac7 (line 482 isMainAgent ternary deleted; combined with prior ba6faf8 + 900cdb6 cleanup; file-level branch coverage reaches 100%) |
| `message-router-unreachable-defensive-branches` | message-router.ts: five unreachable defensive branches block 100% branch coverage | Resolved: 2026-08-25 232fac7 (line 482 isMainAgent ternary deleted; combined with prior ba6faf8 + 900cdb6 cleanup; file-level branch coverage reaches 100%) |
