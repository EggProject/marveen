...
| `channel-request-watcher-unreachable-provider-check` | channel-request-watcher.ts: lookupChannelName's `if (provider !== 'slack') return` is unreachable | Resolved: 3c43926394d2e82caf01c38cd25aee074117acff — Documented only; tripwire comment added at src/web/channel-request-watcher.ts:77. Guard kept as token-leak defense per MD DO NOT RAW-DELETE (commit 1b105fd TOKEN LEAK invariant). |
