...
| `routes-agents-br-baseline-partial-coverage` | routes/agents.ts: remaining uncovered branches after baseline regression tests | Resolved: 2026-08-26 81ef7f6 (throw arm + VALID_PROVIDERS const deleted; kanban priority else-arm covered by agents-routes.test.ts:1100 row addition; file-level branch coverage 99.76% -> 100%) |
