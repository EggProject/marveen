...
| `message-router-cache-fallback-unreachable` | message-router.ts: cached session-lookup `??` fallback arms are unreachable | Partial: 2026-08-25 900cdb6 (3 of 4 `??` arms dropped; 1 `isMainAgent` ternary branch deferred; 97.82% -> 99.24%) -- see MD |
| `message-router-dead-defensive-branches` | message-router.ts: three dead defensive branches block 100% branch coverage | Partial: 2026-08-19 ba6faf8 deleted 2 dead arms; 2026-08-25 900cdb6 dropped 3 of 4 `??` arms at 481-483 (1 isMainAgent ternary deferred); 97.82% -> 99.24% |
| `message-router-unreachable-defensive-branches` | message-router.ts: five unreachable defensive branches block 100% branch coverage | Partial: 2026-08-19 ba6faf8 deleted 2 dead arms; 2026-08-25 900cdb6 dropped 3 of 4 `??` arms at 481-483 (1 isMainAgent ternary deferred); 97.82% -> 99.24% |
