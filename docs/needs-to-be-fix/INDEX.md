...
| `channel-coordinator-internals-untestable` | `src/channel-coordinator.ts:117-441` | internal state-machine functions are not unit-testable | `src/__tests__/channel-coordinator.test.ts` | Resolved: 2026-08-26 (this commit) -- NO-OP, coverage already at 100% (160/160) lines / 100% (117/117) branches via a33dc73+8ea57ba (2026-08-07); the MD's 46%/34% figures were stale, never re-measured |
...
| `web-inbound-probe-respawn-grace` | Defect: stuck mod-scope cache blocks coverage of `shouldTriggerDeafnessRespawn` respawn branches | Resolved: 2026-08-26 (this commit) -- NO-OP, coverage already at 100% (145/145) lines / 100% (74/74) branches; MD fix option 3 was applied in c333a6f (2026-08-08) but never back-annotated |
