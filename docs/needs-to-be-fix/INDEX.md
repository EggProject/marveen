...
| `pane-state-defensive-branches` | `src/pane-state.ts:1064,1066,1104,1136,1161,1165,1497` | unreachable defensive branches block 100% branch coverage | `src/__tests__/pane-state.test.ts` | Resolved: 2026-08-19 84efdfe |
