...
(`find docs/needs-to-be-fix -name '*.md' ! -name 'INDEX.md' ! -name 'README.md' ! -name 'high.md' ! -name 'medium.md' ! -name 'low.md' ! -name 'baseline-unreachable.md' ! -name 'orphan.md' | wc -l` returns 179)
