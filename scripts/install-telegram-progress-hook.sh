...
. "$INSTALL_DIR/scripts/lib/runtime-config.sh"
runtime_config_init "$INSTALL_DIR"
SERVICE_ID="$(runtime_config_get SERVICE_ID)"
MAIN_AGENT_ID_ENV="$(runtime_config_get MAIN_AGENT_ID)"
