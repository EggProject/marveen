...
async function openAgentDetail(agentName) {
  ...
  loadOllamaModels().then(() => {
    ...
    // The model <select> is one shared element reused per agent. A model that
    // is not among the static options (e.g. an Ollama tag the daemon no longer
    // serves) would make setting .value silently show nothing. Inject THIS
